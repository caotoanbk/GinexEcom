      ...
      <div class="modal-body">
                    <form class="form-horizontal"  name ="{{ $name }}" id="content" role="form" action="/require-carrier" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6"><input type='text'  id = 'name' class="form-control" name="name" value=""></div>
                        </div>
                        <div class="form-group">
                            <label class="col-md-4 control-label">Tuyến đường</label>
                            <div class="col-md-6"> <input type='text' id = 'route' class="form-control" name="route" value=""> </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6"> <input type="number" id ='sluong' class="form-control" name="sluong" value=""> </div>
                        </div>
                        <div class="form-group">
                            <label class="col-md-4 control-label">Thời gian giao hàng</label>
                            <div class="col-md-6"> <input type="text" id='time_gh' class="form-control" name="tgghang" value=""> </div>
                        </div>
                        <div class="form-group">
                            <label class="col-md-4 control-label">Thời gian nhận hàng</label>
                            <div class="col-md-6"> <input type="text" id='time_nh' class="form-control" name="tgnhang" value=""> </div>
                        </div>
                        <div class="form-group">
                            <label class="col-md-4 control-label">Mức giá đưa ra</label>
                            <div class="col-md-6"> <input type="text" id='mucgia' class="form-control" name="price" value=""> </div>
                        </div>
                        <div class="form-group">
                            <label class="col-md-4 control-label">Yêu cầu khác</label>
                            <div class="col-md-6"> <textarea class="form-control" id='yckhac' name="description" value=""></textarea> </div>
                        </div>
